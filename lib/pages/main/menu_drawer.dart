...
class MenuDrawerState extends State<MenuDrawer> {
  ...
  Widget build(BuildContext context) {
    return Drawer(
    backgroundColor:context.watch<StoreViewModel>().theme == Brightness.dark ?  Colors.black : Color.fromARGB(255, 249, 249, 249),
        ...
        //菜单头
          DrawerHeader(
            ...
            decoration: BoxDecoration(
              color: context.watch<StoreViewModel>().theme == Brightness.dark ? Colors.black : Colors.lightBlue[400],
            ),
            child: InkWell(
              onTap: () {
                // 头像点击跳转逻辑
          ...
          ...datas.map((TabData data) {
            if (data.index != 4 && data.index != 7) {
              ...
              decoration: BoxDecoration(
              color: context.watch<StoreViewModel>().theme == Brightness.dark ? const Color.fromARGB(93, 119, 119, 119) : Colors.white,
                border: Border(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      icon: Icon(Icons.exit_to_app,size: 24,color: Colors.blue,),
                    ),
                    Text('退出登录',style: TextStyle(fontSize: 16,color: Colors.blue,fontWeight: FontWeight.w400),), // 设置字体为粗体
                  ],
                )
              );
            }else {
