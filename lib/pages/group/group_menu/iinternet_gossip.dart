...
class InternetGossip extends StatefulWidget {
  const InternetGossip({super.key});

  @override
  State<InternetGossip> createState() => _InternetGossipState();
}

class _InternetGossipState extends State<InternetGossip> {
  @override
  ...
  Widget _buildGameProductItem() {
    ...
    return Container(
      ...
      child:Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('网事杂谈板块', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),),
          SizedBox(height: 10,),
          // 判断是否隐藏
            ListView.builder(
            shrinkWrap: true, 
